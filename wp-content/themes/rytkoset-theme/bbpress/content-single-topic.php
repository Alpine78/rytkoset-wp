...
$rytkoset_forum_url   = function_exists( 'bbp_get_forum_permalink' ) ? bbp_get_forum_permalink( $rytkoset_forum_id ) : '';
$rytkoset_forum_name  = function_exists( 'bbp_get_forum_title' ) ? bbp_get_forum_title( $rytkoset_forum_id ) : '';
$rytkoset_reply_count = bbp_get_topic_reply_count( $rytkoset_topic_id );
...
<div class="forum-page__inner">
	...
	<nav class="crumbs" aria-label="<?php esc_attr_e( 'Polku', 'rytkoset-theme' ); ?>">
		...
		<?php endif; ?>
		<?php if ( $rytkoset_forum_url && $rytkoset_forum_name ) : ?>
			<span class="crumbs__sep" aria-hidden="true">›</span>
			<a href="<?php echo esc_url( $rytkoset_forum_url ); ?>"><?php echo esc_html( $rytkoset_forum_name ); ?></a>
		<?php endif; ?>
		<span class="crumbs__sep" aria-hidden="true">›</span>
	...
	<header class="thread-header">
		<?php if ( $rytkoset_forum_url && $rytkoset_forum_name ) : ?>
			<a href="<?php echo esc_url( $rytkoset_forum_url ); ?>" class="thread-header__category">
				...
				<?php echo esc_html( $rytkoset_forum_name ); ?>
			</a>
		<?php endif; ?>
		...
		<div class="thread-header__meta">
			...
			<span>
				<strong><?php echo esc_html( number_format_i18n( (int) $rytkoset_reply_count ) ); ?></strong>
