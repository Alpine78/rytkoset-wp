...
$rytkoset_author    = bbp_get_topic_author_display_name( $rytkoset_topic_id );
$rytkoset_post_date = get_the_date( 'd.m.Y', $rytkoset_topic_id );
$rytkoset_post_time = get_the_time( 'H:i', $rytkoset_topic_id );
$rytkoset_excerpt   = wp_trim_words( wp_strip_all_tags( bbp_get_topic_content( $rytkoset_topic_id ) ), 28, '…' );
?>
<article class="search-result" id="search-topic-<?php echo esc_attr( $rytkoset_topic_id ); ?>">
	...
	<div class="search-result__head">
		...
		<a href="<?php bbp_topic_permalink(); ?>" class="search-result__permalink">#<?php echo esc_html( $rytkoset_topic_id ); ?></a>
	</div>
