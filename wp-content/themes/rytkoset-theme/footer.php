...
<div class="container">
	...
	<a class="site-footer__contact" href="mailto:<?php echo esc_attr( $rytkoset_contact_email ); ?>">
	...
	if ( ! empty( $rytkoset_social_links ) ) :
		?>
	<ul class="site-footer__social-list" aria-label="Sosiaalisen median linkit">
		...
		<a class="site-footer__social-link" href="<?php echo esc_url( $rytkoset_social_link['url'] ); ?>">
