...
- `docs/tietoturva.md`: tietoturvadokumentti, joka kokoaa teemakovennukset (käyttäjien luetteloinnin esto, XML-RPC-esto, tietoturvaotsakkeet) ja palvelin-/ylläpitotason checklistin (2FA, kirjautumisrajoitus, päivitykset, varmuuskopiot, HSTS/CSP, uploads-suojaus, wp-config). Sisältää myös perustelun, miksei wp-login-sivua kannata piilottaa ensisijaisena toimena (#336).
