...
**Vuotosuoja:** `lue_sivu`-työkalu palauttaa vain julkaistuja, salasanattomia `page`-sivuja. Palvelimen lähde-esihaku käyttää sivuille täsmälleen samaa vartijaa; sukukokoushaussa mukaan otettava `rytkoset_event` hyväksytään vain julkaistuna ja salasanattomana. Jäsenille rajatut sivut (#392, `_rytkoset_members_only`) suodatetaan **ehdottomasti ja katsojasta riippumatta**. Kaikki sivun epäämissyyt käyttävät samaa geneeristä käsittelyä, eikä lähteetön fallback kerro, onko rajattua sisältöä olemassa.
