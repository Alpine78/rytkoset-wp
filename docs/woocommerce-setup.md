...
- Maksullisen tapahtuman tuotteet, osallistujakentät, hallinta ja järjestäjäilmoitukset: `docs/woocommerce-event-registration.md`.
- Maksullisen tapahtuman osallistujat näkyvät yhteisessä `Tapahtumat > Osallistujat` -näkymässä; katso `docs/event-participants-admin.md`.
