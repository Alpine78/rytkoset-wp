...
Uuden tapahtuman osallistujakortti päättyy ruokarajoitekenttään; vanhan tuotteen kortti päättyy edelleen buffet-valintaan. `shop.css` sulkee kortin alareunan viimeisen näkyvän kentän mukaan ilman JavaScript-lisäluokkia. Kassalla käytetään yleistä otsikkoa **Tapahtuman osallistujat**, ja uuden tuotteen kortti näyttää tuotteen nimen sekä mahdollisen osallistujatyypin.
