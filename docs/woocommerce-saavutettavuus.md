...
| Tampere 2026 -osallistujakentät (nimi, ruokavalio, buffet) | [`inc/woocommerce-event-registration.php:659`](../wp-content/themes/rytkoset-theme/inc/woocommerce-event-registration.php) | ✅ Rekisteröity `woocommerce_register_additional_checkout_field`-API:lla → WC tuottaa labelit, `aria-required` ja virheilmoitukset itse |
| Tampere 2026 -kassailmoitus | [`inc/woocommerce-event-registration.php:387`](../wp-content/themes/rytkoset-theme/inc/woocommerce-event-registration.php) | ✅ `role="note"` |
